...
\begin{figure}[H]
\centering
\includegraphics[width=0.45\textwidth]{figures/trayectoria_pie_8patas.png}
\caption{Trayectorias de los 8 pies durante un ciclo completo. Cada pata tiene un desfase de 45° para distribución uniforme de carga.}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.45\textwidth]{figures/velocidad_pie_8patas.png}
\caption{Velocidades de los 8 pies. Las velocidades pico alcanzan 94.25 cm/s durante las fases de balanceo.}
\label{fig:velocidad}
\end{figure}
...
\caption{Aceleraciones de los 8 pies. Los picos de aceleración (39,552 cm/s²) ocurren durante transiciones críticas.}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.45\textwidth]{figures/fuerzas_articulaciones_8patas.png}
